...
#   nix-shell --argstr emacs ci-HEAD   # 30.0.50 (barebones; no GUI)
{
  ...
  emacsPkg =
    ...
    then pkgs.emacsGit
    else if emacs == "ci-26.3"
    then pkgs.emacs-26-3
    else if emacs == "ci-27.1"
    then pkgs.emacs-27-1
    else if emacs == "ci-27.2"
    then pkgs.emacs-27-2
    else if emacs == "ci-28.1"
    then pkgs.emacs-28-1
    else if emacs == "ci-28.2"
    then pkgs.emacs-28-2
    else if emacs == "ci-29.1"
    then pkgs.emacs-29-1
    else if emacs == "ci-head"
    then pkgs.emacs-snapshot
    else pkgs.emacs;
in
