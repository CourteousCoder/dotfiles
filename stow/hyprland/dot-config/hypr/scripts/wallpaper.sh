...
# TODO: Maybe make this cachedir configurable?
# ML4W upstream had it in $HOME/.config/ml4w/cache which
# interfered with my git workflow and btrfs snapshots.
# I figure if **I** cared enough to want to change it 
# maybe others may want this too.
# I chose ".cache/<foo>" over ".config/<foo>/cache"
# TODO: Consider picking a better dir name
wallpaper_cache="$HOME/.cache/ml4w"
wallpaper_state="$HOME/.local/state/ml4w"

generatedversions="$wallpaper_cache/wallpaper-generated"
waypaperrunning="$wallpaper_state/waypaper-running.mutex.lock"
cachefile="$wallpaper_cache/current_wallpaper"
blurredwallpaper="$wallpaper_cache/blurred_wallpaper.png"
squarewallpaper="$wallpaper_cache/cache/square_wallpaper.png"
rasifile="$wallpaper_cache/current_wallpaper.rasi"
